...
from typing import Protocol, Any, Type, override
...
class RepoFactory:
    ...
    def build_repo_interface(self: "RepoFactory") -> RepoInterface:
...
def main(args: list[str]) -> int:
    ...
    repo_interface: RepoInterface = repo_factory.build_repo_interface()
    repo_interface.clone_repo(repo_config.repo_id, repo_config.download_path)
